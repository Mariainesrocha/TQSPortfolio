...
//permite incluir anotacoes como a do JUnit, Harmcrest, Mockito...
//lança um servidor aplicacional completo, ex TomCat, meio pesado
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)

// switch AutoConfigureTestDatabase with TestPropertySource to use a real database
//@TestPropertySource( locations = "application-integrationtest.properties")

//permite BD em memoria como o H2 se tiver essa dependencia no POM
...
public class EmployeeRestControllerTemplateIT {
    ...
    //permite simular o cliente HTTP pra testes, permite fazer acoes de POST, GET como no postman
    @Autowired
    ...
    public void givenEmployees_whenGetEmployees_thenStatus200()  {
        ...
        //restTemplate.getEntity retorna um objeto, mas neste caso queremos uma lista entao dps de chamar no GET vamos confirmar os resultados aqui**
        ...
        // assertJ permite chaining dos metodos, ou seja, chamar um após o outro como no exemplo seguinte
        // assertJ é alternativa possivel ao Harmcrest
        //**
