...
public class Dip {
    ...
    private static final int MAX_OF_STARS = 2;
    private static final int MAX_OF_NUMS = 5;

    private static final int MAX_RANGE_STARS = 8;
    private static final int MAX_RANGE_NUMS = 49;
